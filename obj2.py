...
# PARAMETERS
wav_path = 'frontMid_e.wav'# file name
# wav_path = 'frontMid_e.wav' #file name
preemph = 0.97
frame_dur = 0.03              # 30 ms
hop_dur = 0.01                # 10 ms
lifter_ms = 1.5               # for smoothing
max_formant_freq = 5000       # in Hz
min_pitch = 50                # in Hz
max_pitch = 500               # in Hz
peak_prominence = 0.1         # relative prominence
min_consecutive_voiced = 6    # given in assignment
...
if x.ndim > 1:
    x = np.mean(x, axis=1)  # this will convert stereo → mono
x = x.astype(float)
